...
(0, N'Admin'), (1, N'Student'), (2, N'Giảng viên');
...
-- 4. LIÊN KẾT HỒ SƠ GIẢNG VIÊN VẬT LÝ (Bảng gốc phụ trách học phần)
...
-- 5. NẠP DANH MỤC LỚP HÀNH CHÍNH (GVCN lưu tên hiển thị hoặc mã giảng viên tùy ý)
...
-- 9. MỞ CÁC LỚP HỌC PHẦN (Đã sửa đổi cột MSGV để map chuẩn với cấu trúc bảng mới)
