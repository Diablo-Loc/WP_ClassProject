namespace ClassProject
{
    partial class AddStudentForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelImageBorder = new Guna.UI2.WinForms.Guna2Panel();
            picStudent = new Guna.UI2.WinForms.Guna2PictureBox();
            lblDragDropHint = new Label();
            btnChooseImage = new Guna.UI2.WinForms.Guna2Button();
            picLogoUte = new Guna.UI2.WinForms.Guna2PictureBox();
            lblImageFormatHint = new Label();
            lblLabelMssv = new Label();
            txtMSSV = new Guna.UI2.WinForms.Guna2TextBox();
            lblLabelLastName = new Label();
            txtFirstName = new Guna.UI2.WinForms.Guna2TextBox();
            lblLabelFirstName = new Label();
            txtLastName = new Guna.UI2.WinForms.Guna2TextBox();
            lblLabelDob = new Label();
            ...
            // panelImageBorder
            // 
            panelImageBorder.BorderColor = Color.FromArgb(203, 213, 225);
            ...
            // dtpDateOfBirth
            // 
            dtpDateOfBirth.BorderColor = Color.FromArgb(226, 232, 240);
            ...
            cboGender.FocusedState.BorderColor = Color.FromArgb(13, 110, 253);
            ...
            Controls.Add(btnCloseFormX);
            Controls.Add(btnSave);
            Controls.Add(btnCancel);
            Controls.Add(txtHometown);
            Controls.Add(lblLabelHometown);
            Controls.Add(txtEmail);
            Controls.Add(lblLabelEmail);
            Controls.Add(cboGender);
            Controls.Add(lblLabelGender);
            Controls.Add(txtAddress);
            Controls.Add(lblLabelAddress);
            Controls.Add(txtPhone);
            Controls.Add(lblLabelPhone);
            Controls.Add(dtpDateOfBirth);
            Controls.Add(lblLabelDob);
            Controls.Add(txtLastName);
            Controls.Add(lblLabelFirstName);
            Controls.Add(txtFirstName);
            Controls.Add(lblLabelLastName);
            Controls.Add(txtMSSV);
            Controls.Add(lblLabelMssv);
            Controls.Add(lblImageFormatHint);
            Controls.Add(picLogoUte);
            Controls.Add(panelImageBorder);
            ...
            panelImageBorder.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)picStudent).EndInit();
            ((System.ComponentModel.ISupportInitialize)picLogoUte).EndInit();
        ...
        private Guna.UI2.WinForms.Guna2Panel panelImageBorder;
        ...
        private Guna.UI2.WinForms.Guna2PictureBox picLogoUte;
        private System.Windows.Forms.Label lblImageFormatHint;
        private Guna.UI2.WinForms.Guna2TextBox txtMSSV;
        private System.Windows.Forms.Label lblLabelMssv;
        private Guna.UI2.WinForms.Guna2TextBox txtFirstName;
        private System.Windows.Forms.Label lblLabelLastName;
        private Guna.UI2.WinForms.Guna2TextBox txtLastName;
        private System.Windows.Forms.Label lblLabelFirstName;
        private Guna.UI2.WinForms.Guna2DateTimePicker dtpDateOfBirth;
        private System.Windows.Forms.Label lblLabelDob;
        private Guna.UI2.WinForms.Guna2TextBox txtPhone;
        private System.Windows.Forms.Label lblLabelPhone;
        private Guna.UI2.WinForms.Guna2TextBox txtAddress;
        private System.Windows.Forms.Label lblLabelAddress;
        private Guna.UI2.WinForms.Guna2ComboBox cboGender;
        private System.Windows.Forms.Label lblLabelGender;
        private Guna.UI2.WinForms.Guna2TextBox txtEmail;
        private System.Windows.Forms.Label lblLabelEmail;
        private Guna.UI2.WinForms.Guna2TextBox txtHometown;
        private System.Windows.Forms.Label lblLabelHometown;
