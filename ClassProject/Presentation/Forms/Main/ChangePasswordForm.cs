...
using ClassProject.Models; // Gọi lớp chứa UserSession của bạn
    ...
    public partial class ChangePasswordForm : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ClassProject.DataAccess.AccountService accountService = new ClassProject.DataAccess.AccountService();
